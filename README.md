...
```
pip install dist/nomad-tadf-molecules-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-tadf-molecules" is free and open source software
